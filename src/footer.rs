        ...
        <footer class="bg-white dark:bg-gray-900 mt-4">
            <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div class="mb-6 md:mb-0">
                    <a href="https://teio.moe/" class="flex items-center">
                ...
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <ul class="text-gray-600 dark:text-gray-400 font-medium">
                            ...
                            <li class="mb-4">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <p class="hover:underline">"Lisieshy#2304"</p>
                                </div>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul class="text-gray-600 dark:text-gray-400 font-medium">
                            ...
                            <li class="mb-4">
                                <a href="https://github.com/Lisieshy/teio.moe/issues" target="_blank"  class="hover:underline">"Teio.moe issues"</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">"© 2023 "<a href="https://lisieshy.dev/" target="_blank" class="hover:underline">"Lisieshy."</a>" All Rights Reserved."</span>
